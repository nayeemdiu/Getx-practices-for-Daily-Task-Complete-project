...
class CustomNotes extends StatelessWidget {
  ...
  const CustomNotes({super.key,required this.title,required this.decription,required this.dateTime,  required this.onDelete,
    required this.onUpdate,required this.onTab});
